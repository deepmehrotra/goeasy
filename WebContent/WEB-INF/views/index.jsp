        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="seller/orderindex.html">order2revenue</a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">

                     <a class="navbar-brand btn-login" href="login-form.html">Login</a>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="landing/img/avatar3.jpg" class="img-responsive img-circle img-small" alt="">
