...
<script type="text/javascript">
    function submitExpenseGroup(){
    	     $.ajax({
                    url: $("#addExpenseGroupForm").attr("action"),
                    context: document.body,
                    type: 'post',
                    data:$("#addExpenseGroupForm").serialize(),
 ...
 <body>
  ...
  <form:form method="POST" action="${request.contextPath}/goEasy/seller/saveExpenseCategory.html" id="addExpenseGroupForm">
      <table>
       <tr>
       ...
       <tr>
          ...
          <tr>
         <td colspan="2"><input type="button" value="Submit" onclick="submitExpenseGroup()"></td>
        </tr>
   </table> 
  </form:form>
