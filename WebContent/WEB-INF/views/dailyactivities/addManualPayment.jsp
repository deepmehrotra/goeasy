                        ...
                        <div class="ibox-content overflow-h">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mar-btm-20-oh"><label class="col-sm-4 control-label">Payment Cycle</label>
                                    <div class="col-sm-8"><form:input path="orderPayment.paymentCycle" value="${order.orderPayment.paymentCycle}" 
                                    class="form-control"/></div>
                                    </div>
                                    ...
                                    <div ><label class="col-sm-4 control-label">Partner</label>
                                    <div class="col-sm-8"><form:input path="pcName" value="${order.pcName}"
                                     class="form-control"/></div>
                                    </div>
                                </div>
                            </div>
